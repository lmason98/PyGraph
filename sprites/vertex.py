...
class Vertex(Sprite):
	...
	def __init__(self, x: int, y: int, color: (int, int, int) = WHITE, radius: int = 10) -> None:
		"""
	...
	def set_pos(self, x: int, y: int) -> None:
		"""
		Sets the position of the sprite, this should only be called when placing or moving the sprite
		"""
